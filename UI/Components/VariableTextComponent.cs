...
{
    public class VariableTextComponent : IComponent
    {
        protected VariableTextTextComponent InternalComponent { get; set; }
        ...
        public VariableTextComponent(LiveSplitState state)
        {
            Settings = new VariableTextComponentSettings()
            {
                CurrentState = state
            };
            InternalComponent = new VariableTextTextComponent(Settings);
        }
