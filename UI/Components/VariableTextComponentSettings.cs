...
{
    public partial class VariableTextComponentSettings : UserControl
    {
        ...
        public VariableTextComponentSettings()
        {
            InitializeComponent();
        ...
        void VariableTextComponentSettings_Load(object sender, EventArgs e)
        {
